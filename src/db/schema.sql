...
CREATE TABLE IF NOT EXISTS portfolio_holdings(id BIGSERIAL PRIMARY KEY,ticker TEXT NOT NULL,stock_name TEXT,exchange TEXT NOT NULL,shares NUMERIC NOT NULL,entry_price NUMERIC NOT NULL,current_price NUMERIC NOT NULL,buy_date DATE NOT NULL,stop_loss_price NUMERIC,pivot_target_price NUMERIC,notes TEXT,created_at TIMESTAMPTZ DEFAULT now());
